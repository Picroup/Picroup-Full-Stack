...
export const createSaveVideoMediumResolver = ({dependency: {
  ...
  User,
  TagLink,
}}) => async (_, { userId, thumbnailMinioId: minioId, videoMinioId, width, aspectRatio, tags }) => {
  const savedMedium = await Medium.saveVideo({ userId, minioId, videoMinioId, width, aspectRatio, tags });
